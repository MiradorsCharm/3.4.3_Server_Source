...
void WorldSession::LogoutPlayer(bool save)
{
    ...
    if (_player)
    {
        ...
        ///- Remove pet
        _player->RemovePet(nullptr, PET_SAVE_AS_CURRENT, true, true);
...
void WorldSession::InitializeSessionCallback(LoginDatabaseQueryHolder const& holder, CharacterDatabaseQueryHolder const& realmHolder)
{
    ...
    // Send bpay DistributionListResponse before glue screen
    ...
    //SendSyncWowEntitlements();
    SendDisplayPromo(sWorld->getIntConfig(CONFIG_BATTLE_PAY_PROMOTION));
