...
#include "strategy/triggers/HealthTriggers.h"
#include "strategy/triggers/GenericTriggers.h"
#include "strategy/triggers/LootTriggers.h"
#include "../triggers/GenericTriggers.h"
#include "strategy/triggers/LfgTriggers.h"
...
namespace ai
{
    ...
    public:
        TriggerContext()
        {
            ...
            creators["enemy inside ranged dead zone"] = &TriggerContext::enemy_inside_ranged_dead_zone;
    ...
    private:
        ...
        static Trigger* enemy_inside_ranged_dead_zone(PlayerbotAI* ai) { return new EnemyInsideRangedDeadZoneTrigger(ai); }
